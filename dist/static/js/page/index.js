define('page/index', function(require, exports, module) {
    ...
    var IndexAction = app.ActionView.extend({
        ...
        initialize: function() {
            var template = "<h1>首页</h1>跳转到下个页面-><a href=\"#/demo\">demo页11 <i class=\"fa fa-car\"></i></a><br><br>跳转到下个页面(带参数)-><a href=\"#/demo/id/1/sid/2\" class=\"btn btn-default\" role=\"button\" >demo页(带参数)</a><br><br>";
